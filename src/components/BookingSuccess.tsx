      ...
      <div className="relative z-10 w-full max-w-md text-center">
        ...
        >
          <div className="space-y-4 font-body text-[14px]">
            <div className="flex justify-between border-b border-border pb-3">
              ...
              <span className="text-text-primary font-mono">#BKG-8472</span>
            </div>
            <div className="flex justify-between border-b border-border pb-3">
              <span className="text-text-secondary">Date & Time</span>
              <span className="text-text-primary">July 14, 2025 · 4:00 PM</span>
            </div>
            <div className="flex justify-between border-b border-border pb-3">
              <span className="text-text-secondary">Video Type</span>
              <span className="text-text-primary">Instagram Reel</span>
            </div>
            <div className="flex justify-between">
              <span className="text-text-secondary">Amount Paid</span>
              <span className="text-text-primary font-semibold">₹3,999</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            <a
              href="https://wa.me/917893287376?text=Hi%20Salman%2C%20I%20just%20booked%20a%20session!"
              target="_blank"
              rel="noreferrer"
            ...
            >
              ...
              Chat with Salman on WhatsApp →
            </a>
            <Link
              to="/"
              className="w-full border border-accent text-accent hover:bg-accent-soft font-body font-semibold py-3 px-6 rounded-lg transition-colors flex items-center justify-center"
            >
              Back to Home
            </Link>
          </div>
