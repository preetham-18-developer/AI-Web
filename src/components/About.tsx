      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start mb-24">
          ...
          >
            <div className="w-[120px] h-[120px] rounded-full border-3 border-accent flex items-center justify-center bg-surface-2 overflow-hidden mb-6">
              {/* REPLACE: swap this <img src> with Lead Editor's actual photo before going live */}
              <svg className="w-12 h-12 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
              </svg>
            </div>
            
            <h3 className="font-display font-semibold text-[22px] text-text-primary mb-1">Shotzy Lead</h3>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: "🎬", name: "Shotzy Founder", role: "Founder & Creative Director", desc: "Guides creative direction and personally reviews every project before delivery." },
              { icon: "✂️", name: "Editor", role: "Senior Video Editor", desc: "Master of pacing and seamless cuts, specializing in high-impact narrative rhythm." },
              { icon: "🤖", name: "AI Editor", role: "Lead AI Editor", desc: "Engineers custom AI styling, generative assets, and scroll-stopping visual filters." },
              { icon: "📷", name: "Photographer", role: "Director of Photography", desc: "Captures stunning, high-resolution original footage and cinematic angles." }
            ].map((member, i) => (
              <motion.div
                key={member.name}
                initial={{ opacity: 0, y: 20 }}
